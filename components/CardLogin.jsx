  ...
  return (
    <div className="min-h-screen flex flex-col gap-5 items-center justify-center bg-gray-50 dark:bg-gray-900 py-12 px-4 sm:px-6 lg:px-8">
        <Form {...form}>
            ...
            <form onSubmit={form.handleSubmit(handleLogin)} className="mt-8 space-y-6 flex flex-col items-center justify-center">
                <FormField
                ...
                />
                {loginError && <div className='text-red-600'>User does not exist or incorrect password</div>}
